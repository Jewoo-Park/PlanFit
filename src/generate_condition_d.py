...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="outputs/condition_d")
    args = parser.parse_args()

    personas = load_jsonl(args.input)
    model_cfg = load_yaml(args.models_config)["models"]["strong"]
    ...
    for persona in tqdm(personas, desc="Condition D"):
        prompt = build_prompt("D", persona, prompts_cfg)
